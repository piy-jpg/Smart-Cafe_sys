...
const ManagerSidebar = ({
  ...
  const navItems = [
    ...
    },
    {
      id: 'orders',
      label: 'Orders',
      badge: badgeCounts.activeOrders > 0 ? badgeCounts.activeOrders : null,
    ...
    },
    {
      id: 'tables',
      label: 'Tables',
      badge: badgeCounts.occupiedTables > 0 ? `${badgeCounts.occupiedTables} Occ` : null,
    ...
    },
    {
      id: 'inventory',
      label: 'Inventory',
      badge: badgeCounts.lowStockCount > 0 ? badgeCounts.lowStockCount : null,
    ...
    },
    {
      id: 'billing',
      label: 'Billing',
      badge: badgeCounts.unpaidBills > 0 ? badgeCounts.unpaidBills : null,
    ...
    <aside className="pos-sidebar flex-shrink-0">
      ...
      <div className="sidebar-logo flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="text-[10px] uppercase font-bold tracking-wider text-sky-400 mt-1">Management SaaS</div>
          </div>
        </div>
          ...
          return (
            ...
            >
              ...
              {item.badge !== null && item.badge !== undefined && (
                <span
                  className={`ml-2 px-2 py-0.5 text-[11px] font-bold rounded-full text-white ${
      ...
      <div className="sidebar-footer">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-blue-600 rounded-full flex items-center justify-center text-sm font-bold text-white shadow-sm ring-2 ring-blue-400/20 flex-shrink-0">
              {managerInitial}
            </div>
